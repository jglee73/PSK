...
public:		
	...
	int InsertItem(int nItem, LPCSTR lpText, COLORREF textColor, COLORREF backColor,BOOL redraw = TRUE);
	...
	BOOL SetItemText(int nItem, int nSubItem, LPCSTR lpText, COLORREF textColor, COLORREF backColor, BOOL redraw = TRUE);
	...
	void SetNoSort(bool sort)	{ m_bNoSort = sort;	};
