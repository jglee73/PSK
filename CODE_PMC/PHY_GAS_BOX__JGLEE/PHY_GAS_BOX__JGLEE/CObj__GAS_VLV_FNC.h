...
private:
	...
	// OBJ.DB_SYS ...
	CX__VAR_DIGITAL_CTRL dEXT_CH__ACTIVEINTERLOCK_CHAMBER_VENT;

	// CH.PUMPING_STATE ...
	CX__VAR_STRING_CTRL  sEXT_CH__CHM_PUMPING_STATE;

	// CH.DRY_PUMP_STATE ...
	CX__VAR_STRING_CTRL  sEXT_CH__DRY_PUMPING_STATE;
	...
	CX__VAR_STRING_CTRL  sEXT_CH__MON_MFC_STATE[_MAX__MFC_OBJ];
