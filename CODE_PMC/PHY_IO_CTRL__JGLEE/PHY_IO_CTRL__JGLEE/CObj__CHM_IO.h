...
private:
	...
	CX__VAR_ANALOG_CTRL   aCH__CFG_PROCESS_MANOMETER_MAX_PRESSURE_mTORR_X[_CFG__PROC_GAUGE_SIZE];
	CX__VAR_ANALOG_CTRL   aCH__CFG_PROCESS_MANOMETER_LIMIT_PRESSURE_mTORR_X[_CFG__PROC_GAUGE_SIZE];

	CX__VAR_DIGITAL_CTRL  dCH__CFG_ALL_MFC_CLOSE_WHEN_VAC_SNS_OFF;
	...
	//
	int iSIZE__PROC_GAUGE;
	CX__VAR_DIGITAL_CTRL  dEXT_CH__DO_PROC_GAUGE_ISO_VLV_X[_CFG__PROC_GAUGE_SIZE];

	bool bActive__AI_PROC_GAUGE_TORR_X[_CFG__PROC_GAUGE_SIZE];
	CX__VAR_ANALOG_CTRL   aEXT_CH__AI_PROC_GAUGE_TORR_X[_CFG__PROC_GAUGE_SIZE];

	bool bActive__AI_PROC_GAUGE_mTORR_X[_CFG__PROC_GAUGE_SIZE];
	CX__VAR_ANALOG_CTRL   aEXT_CH__AI_PROC_GAUGE_mTORR_X[_CFG__PROC_GAUGE_SIZE];
	...
	bool bActive__AI_FORELINE_GAUGE_mTORR;
	CX__VAR_ANALOG_CTRL   aEXT_CH__AI_FORELINE_GAUGE_mTORR;
	...
	int iDATA__MFC_SIZE;
	CII_EXT_OBJECT__CTRL* pOBJ__NFC_CTRL_X[_CFG__MFC_SIZE];
