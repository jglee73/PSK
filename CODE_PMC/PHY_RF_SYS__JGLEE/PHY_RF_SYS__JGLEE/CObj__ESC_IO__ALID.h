...
#define  ALID__HE_WAFER_MINIMUM_LEAK_SCCM_ACT					    14
#define  ALID__HE_WAFER_MAXIMUM_LEAK_SCCM_ACT	     				15

#define  ALID__HE_WAFER_MAXIMUM_LEAK_SCCM_CENTER_MON				16
#define  ALID__HE_WAFER_MAXIMUM_LEAK_SCCM_EDGE_MON					17
