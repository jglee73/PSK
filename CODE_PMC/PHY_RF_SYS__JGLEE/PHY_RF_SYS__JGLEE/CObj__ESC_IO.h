...
private:
	...
	CX__VAR_STRING_CTRL  sCH__MON_FAULT_HE_LEAK_CENTER_STATE;
	...
	CX__VAR_STRING_CTRL  sCH__MON_FAULT_HE_LEAK_EDGE_STATE;
	...
	CX__VAR_DIGITAL_CTRL dCH__CFG_He_DUMP_VALVE_CLOSE_DURING_DECHUCK;
	...
	CX__VAR_ANALOG_CTRL  aCH__CFG_DECHUCK_VERIFY_CHECK_COUNT;
	...
	CX__VAR_ANALOG_CTRL  aCH__CFG_DECHUCK_X__STEPx_HE[DEF__DECHUCK_MODE_SIZE][DEF_DECHUCK__STEP_SIZE];
	...
	CX__VAR_ANALOG_CTRL  aCH__CFG_DECHUCK_X__LAST_HE[DEF__DECHUCK_MODE_SIZE];
	...
	// CFG Option ...
	CX__VAR_DIGITAL_CTRL dCH__CFG_WAFER_DUMP_LINE_OPEN_DURING_PRE_CHUCKING;
	CX__VAR_DIGITAL_CTRL dCH__CFG_STABLE_VALVE_OPEN_DURING_CHUCKING;
	CX__VAR_DIGITAL_CTRL dCH__CFG_HE_VALVE_CLOSE_WHEN_ERROR;
	CX__VAR_DIGITAL_CTRL dCH__CFG_HE_DUMP_VALVE_OPEN_AFTER_DECHUCK;
	CX__VAR_DIGITAL_CTRL dCH__CFG_HE_DONOT_CHECK_DURING_ON_RF;//KMS
	//
	...
	CX__VAR_DIGITAL_CTRL dEXT_CH__RF_ON_STAUTS;
	...
	CX__VAR_DIGITAL_CTRL doEXT_CH__ESC_VOLTAGE_ON; // KMS
	...
	int  Fnc__HE_SET_OF_DECHUCK(const double center__he_set, 
								const double edge__he_set);
	...
	// ...
	int  Check__Stable_Valve_Open_Of_HE_CENTER();
	int  Check__Stable_Valve_Open_Of_HE_EDGE();
	//
