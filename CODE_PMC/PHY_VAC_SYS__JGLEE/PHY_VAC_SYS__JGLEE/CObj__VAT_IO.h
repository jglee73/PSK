...
#define  _VAT_HEXA_TYPE__STD				11
#define  _VAT_HEXA_TYPE__USER				12
...
private:
	...
	// CFG.INTERLOCK ...
	CX__VAR_DIGITAL_CTRL  dCH__CFG_INTERLOCK_TMP_LINE_CHECK;
	//
	...
	int iDATA__VAT_HEXA_TYPE;

	CString sDATA__HEXA_CLOSE;
	CString sDATA__HEXA_OPEN;
	CString sDATA__HEXA_CONTROL;
	...
	CX__VAR_STRING_CTRL   sEXT_CH__SO_APC_PRESSURE_DATA;
	CX__VAR_STRING_CTRL   sEXT_CH__SO_APC_POSITION_DATA;
