...
private:
	...
	// PARA ...
	CX__VAR_DIGITAL_CTRL dCH__PARA_CONTROL_MODE_CH;		
	CX__VAR_ANALOG_CTRL  aCH__PARA_ACTIVE_PRESET_CH;		
	

	//
	CX__VAR_ANALOG_CTRL  aCH__PARA_LOAD_POS_CH;
	CX__VAR_STRING_CTRL  sCH__CUR_LOAD_POS_CH;

	//
	CX__VAR_ANALOG_CTRL  aCH__PARA_TUNE_POS_CH;
	CX__VAR_STRING_CTRL  sCH__CUR_TUNE_POS_CH;
	...
	// INFO ...
	CX__VAR_STRING_CTRL  sCH__INFO_CTRL_MODE_CH;	  
	CX__VAR_ANALOG_CTRL  aCH__INFO_LOAD_POS_CH;	  
	CX__VAR_ANALOG_CTRL  aCH__INFO_TUNE_POS_CH;	  
	...
	// IO CHANNEL  -----------------------------------
	// SI ...
	CX__VAR_STRING_CTRL  siCH__CTRL_MODE_HEXA_CH;

	CX__VAR_STRING_CTRL  siCH__CAPACITOR_POS_HEXA_CH;
	...
	CX__VAR_STRING_CTRL  siCH__REPORT_CONDENSED_MATCH_SNAPSHOT; // KMS:221102 

	// DO ...
	CX__VAR_DIGITAL_CTRL doCH__ALL_CAPACITOR_INIT;		
	CX__VAR_DIGITAL_CTRL doCH__CAPACITOR_LIMIT_CH;		
	CX__VAR_DIGITAL_CTRL doCH__CONTROL_MODE_CH;		
	CX__VAR_DIGITAL_CTRL doCH__INTERNAL_EXTERNAL_PRESET_CH;		
	CX__VAR_DIGITAL_CTRL doCH__ACTIVE_PRESET_CH;		
	CX__VAR_DIGITAL_CTRL doCH__LOAD_POS_CH;		
	CX__VAR_DIGITAL_CTRL doCH__TUNE_POS_CH;		
	CX__VAR_DIGITAL_CTRL doCH__CAPACITOR_MOTOR_POS_CH;

	CX__VAR_ANALOG_CTRL  aCH__CFG_LOAD_MIN_CH;
	CX__VAR_ANALOG_CTRL  aCH__CFG_LOAD_MAX_CH;
	CX__VAR_ANALOG_CTRL  aCH__CFG_TUNE_MIN_CH;
	CX__VAR_ANALOG_CTRL  aCH__CFG_TUNE_MAX_CH;
	
	CX__VAR_DIGITAL_CTRL doCH__AUXILIARY_CAP_POS; // KMS
	...
	float _Convert_Tofloat(int start_idx, int end_idx, unsigned char *data);
