...
private:
	...
	// CFG.ROBOT ...
	CX__VAR_ANALOG_CTRL  aCH__CFG_ROBOT_SPEED_PERCENT;
	...
	CX__VAR_ANALOG_CTRL  aCH__PARA_RB_STAGE_CODE;
	...
	CX__VAR_STRING_CTRL  sCH__MON_AL_BUSY_STATE;
	...
	CX__VAR_DIGITAL_CTRL dCH__CFG_ALIGN_MEASUREMENT_USE;
	...
	CString sMODE__HOME;
	int  Call__HOME(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm, const bool active__al_init);

	CString sMODE__ERROR_RESET;
	int  Call__ERROR_RESET(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);
	...
	int  Call__AL_INIT(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);
	int  Fnc__AL_INIT(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);

	CString sMODE__ALIGN;
	int  Call__ALIGN(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);
	int  Fnc__ALIGN(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);

	CString sMODE__AL_CHUCK_ON;
	int  Call__AL_CHUCK_ON(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);

	CString sMODE__AL_CHUCK_OFF;
	int  Call__AL_CHUCK_OFF(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);

	// ...
	int  _Wait__RB_ACTION(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);
	int  __Wait__RB_ACTION(CII_OBJECT__VARIABLE* p_variable);

	int  _Wait__AL_ACTION(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);
	int  __Wait__AL_ACTION(CII_OBJECT__VARIABLE* p_variable);
	...
	// ...
	int  Get__CFG_STN_NUM(const CString& stn_name,const CString& stn_slot, CString& stage_code,CString& stn_id,CString& pos_slot);	
