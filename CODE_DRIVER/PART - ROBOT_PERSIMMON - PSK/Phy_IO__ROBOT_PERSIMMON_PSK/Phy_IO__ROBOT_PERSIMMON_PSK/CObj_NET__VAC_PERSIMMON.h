...
private:
	...
	CX__VAR_STRING_CTRL  sCH__DRV_INFO_ROBOT_SPEED;
	...
	// CFG ...
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_CFG__LLx_STN_NUM_X[CFG_LLx__SIZE][CFG_LLx__SLOT_SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_CFG__PMx_STN_NUM[CFG_PMx__SIZE];	

	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_CFG_LLx_CPTR_SNS_NUM_X[CFG_LLx__SIZE][CFG_LLx__SLOT_SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_CFG_PMx_CPTR_SNS_NUM[CFG_PMx__SIZE];

	CX__VAR_ANALOG_CTRL  aCH__CFG_ROBOT_SPEED_PERCENT;

	CX__VAR_DIGITAL_CTRL dCH__CFG_ROBOT_DRV_WAFER_CHECK;
	...
	CString	Get__CFG_STN_NUM(const CString& stn_name, const int slot_id);	
	CString	Get__CFG_DYNAMIC_ALGN_USE(const CString& stn_name);	
	CString Get__CFG_STN_CPTR_NUM(const CString& stn_name, const int slot_id);	
