				  ...
				  CII_OBJECT__ALARM* p_alarm)
{
	if(iActive__SIM_MODE > 0)
	{
		// ...
		{
			...
			dCH__MON_ACTIVE_WARNING->Set__DATA(STR__OFF);

			sCH__MON_MODE_STS->Set__DATA(STR__Ready);
			sCH__MON_VERSION->Set__DATA("Ver 1.0");

			sCH__MON_PUMP_BODY_TEMPERATURE->Set__DATA("35.0");
			sCH__MON_EXHAUST_PRESSURE->Set__DATA("0.001");
			sCH__MON_PUMP_MOTOR_CURRENT->Set__DATA("0.01");
			sCH__MON_BLOWER_MOTOR_CURRENT->Set__DATA("0.015");
		}
