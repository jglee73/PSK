...
private:
	...
	CX__VAR_DIGITAL_CTRL dCH__MON_ACTIVE_NORMAL_STATE;
	CX__VAR_DIGITAL_CTRL dCH__MON_ACTIVE_ACCELERATION_STATE;

	// PARA ...
	CX__VAR_ANALOG_CTRL  aCH__PARA_TARGET_SPEED_RPM;
	CX__VAR_ANALOG_CTRL  aCH__PARA_AACCELERATION_TIMEOUT;
	CX__VAR_ANALOG_CTRL  aCH__PARA_TARGET_SPEED_TIMEOUT;

	CX__VAR_ANALOG_CTRL  aCH__PARA_STOP_TIMEOUT;

	// CFG ...
	CX__VAR_DIGITAL_CTRL dCH__CFG_CONTROL_TYPE;
	CX__VAR_ANALOG_CTRL  aCH__CFG_DRV_MON_INTERVAL;
	...
	CX__VAR_STRING_CTRL  sCH__INFO_MOTOR_TEMPERATURE_READ;
	...
	// SI ...
	CX__VAR_STRING_CTRL  siCH__ReadMeasValue_Result;
	CX__VAR_STRING_CTRL  siCH__ReadModFonct;

	CX__VAR_STRING_CTRL  siCH__All_Version_Manual;
	CX__VAR_STRING_CTRL  siCH__Read_SetPoint_Manual;
	//
