...
Fnc__INIT(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm)
{
	...
	// Update.Info ...
	{
		siCH__All_Version_Manual->Get__STRING();
	}
...
ACT_RETRY:
	...
	// TMP Start ...
	{
		double trg_rpm = aCH__PARA_TARGET_SPEED_RPM->Get__VALUE();
	...
	// Update.Info ...
	{
		siCH__Read_SetPoint_Manual->Get__STRING();
	}

	// Acceleration Check ...
	{
		double cfg_sec = aCH__PARA_AACCELERATION_TIMEOUT->Get__VALUE();
	...
	// Normal Check ...
	{
		double cfg_sec = aCH__PARA_TARGET_SPEED_TIMEOUT->Get__VALUE();
...
Call__AUTO_STOP(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm)
{
	...
	// STOP Check ...
	{
		double cfg_sec = aCH__PARA_STOP_TIMEOUT->Get__VALUE();
