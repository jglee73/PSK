...
int CObj__STP_SERIAL::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// MON ...
	{
		...
		//
		str_name = "MON.ACTIVE.NORMAL.STATE";
		STD__ADD_DIGITAL(str_name, "OFF ON");
		LINK__VAR_DIGITAL_CTRL(dCH__MON_ACTIVE_NORMAL_STATE, str_name);

		str_name = "MON.ACTIVE.ACCELERATION.STATE";
		STD__ADD_DIGITAL(str_name, "OFF ON");
		LINK__VAR_DIGITAL_CTRL(dCH__MON_ACTIVE_ACCELERATION_STATE, str_name);
	}

	// PARA ...
	{
		str_name = "PARA.TARGET_SPEED.RPM";
		STD__ADD_ANALOG_WITH_X_OPTION(str_name, "rpm", 0, 0, 27000, "");
		LINK__VAR_ANALOG_CTRL(aCH__PARA_TARGET_SPEED_RPM, str_name);

		str_name = "PARA.ACCELERATION.TIMEOUT";
		STD__ADD_ANALOG_WITH_X_OPTION(str_name, "sec", 0, 0, 600, "");
		LINK__VAR_ANALOG_CTRL(aCH__PARA_AACCELERATION_TIMEOUT, str_name);

		str_name = "PARA.TARGET_SPEED.TIMEOUT";
		STD__ADD_ANALOG_WITH_X_OPTION(str_name, "sec", 0, 0, 600, "");
		LINK__VAR_ANALOG_CTRL(aCH__PARA_TARGET_SPEED_TIMEOUT, str_name);

		//
		str_name = "PARA.STOP.TIMEOUT";
		STD__ADD_ANALOG_WITH_X_OPTION(str_name, "sec", 0, 0, 6000, "");
		LINK__VAR_ANALOG_CTRL(aCH__PARA_STOP_TIMEOUT, str_name);
	}
	...
	// CFG ...
	{
		...
		//
		str_name = "CFG.DRV.MON.INTERVAL";
		STD__ADD_ANALOG_WITH_X_OPTION(str_name, "msec", 0, 0, 1000, "");
		LINK__VAR_ANALOG_CTRL(aCH__CFG_DRV_MON_INTERVAL, str_name);
	}
	...
	// INFO ...
	{
		...
		//
		str_name = "INFO.MOTOR_TEMPERATURE.READ";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__INFO_MOTOR_TEMPERATURE_READ, str_name);
	...
	// ...
	{
		p_variable->Add__MONITORING_PROC(4.0, MON_ID__STATE_CHECK);
	}
	return 1;
}
...
int CObj__STP_SERIAL::__DEFINE__VARIABLE_IO(p_io_variable)
{
	...
	// SI ...
	{
		...
		str_name = "si.MeasValue_Result";
		IO__ADD_STRING_READ_WITH_OPTION(str_name, "", "", "", 0.1, "");
		LINK__IO_VAR_STRING_CTRL(siCH__ReadMeasValue_Result, str_name);

		//
		str_name = "si.All_Version.Manual";
		IO__ADD_STRING_READ__MANUAL(str_name);
		LINK__IO_VAR_STRING_CTRL(siCH__All_Version_Manual, str_name);

		str_name = "si.Read_SetPoint.Manual";
		IO__ADD_STRING_READ__MANUAL(str_name);
		LINK__IO_VAR_STRING_CTRL(siCH__Read_SetPoint_Manual, str_name);
	}
