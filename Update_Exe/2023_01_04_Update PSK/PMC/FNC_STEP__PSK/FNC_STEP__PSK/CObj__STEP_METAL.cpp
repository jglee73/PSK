...
int CObj__STEP_METAL::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	...
	// OBJ APC ...
	{
		...
		if(def_check)
		{
			...
			//
			var_name = "PARA.PRESSURE.mTORR";
			LINK__EXT_VAR_ANALOG_CTRL(aEXT_CH__APC_OBJ__PARA_PRESSURE_mTORR, obj_name,var_name);
			...
			//
			var_name = "MON.PRESSURE.mTORR";
			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__APC_OBJ__MON_PRESSURE_mTORR, obj_name,var_name);
