...
private:
	...
	CX__VAR_ANALOG_CTRL  aCH__PARA_LEAK_CURRUNT_LIMIT_mA;
	CX__VAR_ANALOG_CTRL  aCH__PARA_TIME_DELAY_mSEC;    
	CX__VAR_ANALOG_CTRL  aCH__PARA_RAMP_UP_mSEC;
	CX__VAR_ANALOG_CTRL  aCH__PARA_RAMP_DOWN_mSEC;

	// MON...
	CX__VAR_STRING_CTRL  sCH__MON_ESC_STABLE_DELAY_TIME; 
	...
	// CFG ...
	CX__VAR_ANALOG_CTRL  aCH__CFG_LEAK_CURRUNT_LIMIT_mA;
	CX__VAR_ANALOG_CTRL  aCH__CFG_STABLE_DELAY_SEC;			// KMS

	CX__VAR_ANALOG_CTRL  aCH__CFG_RAMP_UP_mSEC;
	CX__VAR_ANALOG_CTRL  aCH__CFG_RAMP_DOWN_mSEC;

	CX__VAR_ANALOG_CTRL aCH__ESC_VOLTAGE_V;
	//

	// IO CHANNEL  -----------------------------------
	// AO ...
	CX__VAR_ANALOG_CTRL aoCH__ESC_VOLTAGE_SET_V;
	CX__VAR_ANALOG_CTRL aoCH__ESC_CURRENT_LIMIT_SET_mA;

	CX__VAR_ANALOG_CTRL aoCH__ESC_TIME_DELAY_mSEC;
	CX__VAR_ANALOG_CTRL aoCH__ESC_RAMP_UP_mSEC;
	CX__VAR_ANALOG_CTRL aoCH__ESC_RAMP_DOWN_mSEC;
	...
	// SI ...
	CX__VAR_STRING_CTRL  siCH__ESC_VOLTAGE_V;
	CX__VAR_STRING_CTRL  siCH__ESC_LEAK_CURRENT_mA;
	...
	CString sMODE__PARA_SET;
	int  Call__PARA_SET(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm);
