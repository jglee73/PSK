...
//--------------------------------------------------------------------------------
CObj__VacRobot_WAVEII::CObj__VacRobot_WAVEII()
{
	m_sErrorID  =   "0";
	m_sStationA =	"1";
	m_sStationB =	"1";
...
//--------------------------------------------------------------------------------
int CObj__VacRobot_WAVEII::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj__VacRobot_WAVEII::__DEFINE__VERSION_HISTORY(version)
{
	version = "JG.Lee \n";
...
// ...
#define  APP_DSP__RB_TARGET_MOVE		"UNKNOWN HOME READY PM1 PM2 PM3 PM4 PM5 PM6 LBA LBB"
...
int CObj__VacRobot_WAVEII::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	str_name = "dDA.PM2.CHART.ARM.A.UPDATE.FLAG";	// ON이면 GUI에 Update 된다.
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM2_CHART_ARM_A_UPDATE_FLAG,str_name);
	
	str_name = "dDA.PM2.CHART.ARM.B.UPDATE.FLAG";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM2_CHART_ARM_B_UPDATE_FLAG,str_name);
	
	str_name = "dDA.PM2.CHART.DATA.CLEAR";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM2_CHART_DATA_CLEAR,str_name);

	str_name = "dDA.PM3.CHART.ARM.A.UPDATE.FLAG";	// ON이면 GUI에 Update 된다.
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM3_CHART_ARM_A_UPDATE_FLAG,str_name);
	
	str_name = "dDA.PM3.CHART.ARM.B.UPDATE.FLAG";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM3_CHART_ARM_B_UPDATE_FLAG,str_name);
	
	str_name = "dDA.PM3.CHART.DATA.CLEAR";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM3_CHART_DATA_CLEAR,str_name);

	str_name = "dDA.PM4.CHART.ARM.A.UPDATE.FLAG";	// ON이면 GUI에 Update 된다.
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM4_CHART_ARM_A_UPDATE_FLAG,str_name);
	
	str_name = "dDA.PM4.CHART.ARM.B.UPDATE.FLAG";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM4_CHART_ARM_B_UPDATE_FLAG,str_name);
	
	str_name = "dDA.PM4.CHART.DATA.CLEAR";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_PM4_CHART_DATA_CLEAR,str_name);

	str_name = "dDA.LBA.CHART.ARM.A.UPDATE.FLAG";	// ON이면 GUI에 Update 된다.
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_LBA_CHART_ARM_A_UPDATE_FLAG,str_name);
	
	str_name = "dDA.LBA.CHART.ARM.B.UPDATE.FLAG";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_LBA_CHART_ARM_B_UPDATE_FLAG,str_name);
	
	str_name = "dDA.LBA.CHART.DATA.CLEAR";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_LBA_CHART_DATA_CLEAR,str_name);

	str_name = "dDA.LBB.CHART.ARM.A.UPDATE.FLAG";	// ON이면 GUI에 Update 된다.
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_LBB_CHART_ARM_A_UPDATE_FLAG,str_name);
	
	str_name = "dDA.LBB.CHART.ARM.B.UPDATE.FLAG";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_LBB_CHART_ARM_B_UPDATE_FLAG,str_name);
	
	str_name = "dDA.LBB.CHART.DATA.CLEAR";
	STD__ADD_DIGITAL(str_name, "OFF ON");
	LINK__VAR_DIGITAL_CTRL(dDA_LBB_CHART_DATA_CLEAR,str_name);


	// DA CHART에 좌표를 찍는다.
	str_name = "sDA.PM1.CHART.ARM.A.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM1_CHART_ARM_A_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM1.CHART.ARM.A.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM1_CHART_ARM_A_TOFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM1.CHART.ARM.B.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM1_CHART_ARM_B_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM1.CHART.ARM.B.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM1_CHART_ARM_B_TOFFSET_DISPLAY,str_name);


	// DA CHART에 좌표를 찍는다.
	str_name = "sDA.PM2.CHART.ARM.A.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM2_CHART_ARM_A_ROFFSET_DISPLAY,str_name);

	str_name = "sDA.PM2.CHART.ARM.A.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM2_CHART_ARM_A_TOFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM2.CHART.ARM.B.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM2_CHART_ARM_B_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM2.CHART.ARM.B.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM2_CHART_ARM_B_TOFFSET_DISPLAY,str_name);


	// DA CHART에 좌표를 찍는다.
	str_name = "sDA.PM3.CHART.ARM.A.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM3_CHART_ARM_A_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM3.CHART.ARM.A.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM3_CHART_ARM_A_TOFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM3.CHART.ARM.B.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM3_CHART_ARM_B_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM3.CHART.ARM.B.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM3_CHART_ARM_B_TOFFSET_DISPLAY,str_name);

	// DA CHART에 좌표를 찍는다.
	str_name = "sDA.PM4.CHART.ARM.A.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM4_CHART_ARM_A_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM4.CHART.ARM.A.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM4_CHART_ARM_A_TOFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM4.CHART.ARM.B.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM4_CHART_ARM_B_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM4.CHART.ARM.B.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM4_CHART_ARM_B_TOFFSET_DISPLAY,str_name);
	
	// DA CHART에 좌표를 찍는다.
	str_name = "sDA.LBA.CHART.ARM.A.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBA_CHART_ARM_A_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.LBA.CHART.ARM.A.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBA_CHART_ARM_A_TOFFSET_DISPLAY,str_name);
	
	str_name = "sDA.LBA.CHART.ARM.B.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBA_CHART_ARM_B_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.LBA.CHART.ARM.B.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBA_CHART_ARM_B_TOFFSET_DISPLAY,str_name);
	
	// DA CHART에 좌표를 찍는다.
	str_name = "sDA.LBB.CHART.ARM.A.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBB_CHART_ARM_A_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.LBB.CHART.ARM.A.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBB_CHART_ARM_A_TOFFSET_DISPLAY,str_name);
	
	str_name = "sDA.LBB.CHART.ARM.B.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBB_CHART_ARM_B_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.LBB.CHART.ARM.B.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBB_CHART_ARM_B_TOFFSET_DISPLAY,str_name);
	...
	//
	str_name = "sDA.PM1.CHART.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM1_CHART_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM1.CHART.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM1_CHART_TOFFSET_DISPLAY,str_name);

	str_name = "sDA.PM2.CHART.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM2_CHART_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM2.CHART.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM2_CHART_TOFFSET_DISPLAY,str_name);

	str_name = "sDA.PM3.CHART.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM3_CHART_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM3.CHART.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM3_CHART_TOFFSET_DISPLAY,str_name);

	str_name = "sDA.PM4.CHART.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM4_CHART_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.PM4.CHART.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_PM4_CHART_TOFFSET_DISPLAY,str_name);

	str_name = "sDA.LBA.CHART.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBA_CHART_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.LBA.CHART.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBA_CHART_TOFFSET_DISPLAY,str_name);

	str_name = "sDA.LBB.CHART.ROFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBB_CHART_ROFFSET_DISPLAY,str_name);
	
	str_name = "sDA.LBB.CHART.TOFFSET.DISPLAY";
	STD__ADD_STRING(str_name);
	LINK__VAR_STRING_CTRL(sDA_LBB_CHART_TOFFSET_DISPLAY,str_name);
	...
	// --------- LBA
	// Hard
	str_name.Format("OTR.IN.CFG.LBA.R.OFFSET.HARD.TOLERANCE.RET");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "mm", 1, 0, 4, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__R_OFFSET_HARD_TOLERANCE_LBA_RET,str_name);

	str_name.Format("OTR.IN.CFG.LBA.T.OFFSET.HARD.TOLERANCE.RET");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "degree", 1, 0, 2, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__T_OFFSET_HARD_TOLERANCE_LBA_RET,str_name);

	// Soft
	str_name.Format("OTR.IN.CFG.LBA.R.OFFSET.SOFT.TOLERANCE.RET");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "mm", 1, 0, 4, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__R_OFFSET_SOFT_TOLERANCE_LBA_RET,str_name);

	str_name.Format("OTR.IN.CFG.LBA.T.OFFSET.SOFT.TOLERANCE.RET");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "degree", 1, 0, 2, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__T_OFFSET_SOFT_TOLERANCE_LBA_RET,str_name);

	// --------- LBB
	// Hard
	str_name.Format("OTR.IN.CFG.LBB.R.OFFSET.HARD.TOLERANCE.RET");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "mm", 1, 0, 4, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__R_OFFSET_HARD_TOLERANCE_LBB_RET,str_name);

	str_name.Format("OTR.IN.CFG.LBB.T.OFFSET.HARD.TOLERANCE.RET");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "degree", 1, 0, 2, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__T_OFFSET_HARD_TOLERANCE_LBB_RET,str_name);

	// Soft
	str_name.Format("OTR.IN.CFG.LBB.R.OFFSET.SOFT.TOLERANCE.RET");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "mm", 1, 0, 4, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__R_OFFSET_SOFT_TOLERANCE_LBB_RET,str_name);

	str_name.Format("OTR.IN.CFG.LBB.T.OFFSET.SOFT.TOLERANCE.RET");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "degree", 1, 0, 2, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__T_OFFSET_SOFT_TOLERANCE_LBB_RET,str_name);
	...
	{
		str_name.Format("OTR.IN.CFG.aPM%1d.STN.NUM",i+1);
		str_comment.Format("PM%1d STN NUM",i+1);

		STD__ADD_ANALOG_WITH_X_OPTION(str_name, "num", 0, 1, 16, str_comment);
		LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG__PMx_STN_NUM[i],str_name);

		// VAC_RB CPTR Sensor Number
		str_name.Format("OTR.IN.CFG.VACRB.CPTR.SNS.PM%1d.NUM", i+1);
	...
	// ------------------------ ARM_A
	// LL1 HIGH
	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.R.HIGH.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL1_CPTR_R_HIGH_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.T.HIGH.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL1_CPTR_T_HIGH_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.Z.HIGH.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL1_CPTR_Z_HIGH_SNS_VAL,str_name);

	// LL1 LOW
	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.R.LOW.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL1_CPTR_R_LOW_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.T.LOW.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL1_CPTR_T_LOW_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.Z.LOW.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL1_CPTR_Z_LOW_SNS_VAL,str_name);

	// ------------------------ ARM_B
	// LL1 HIGH
	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.R.HIGH.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL1_CPTR_R_HIGH_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.T.HIGH.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL1_CPTR_T_HIGH_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.Z.HIGH.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL1_CPTR_Z_HIGH_SNS_VAL,str_name);

	// LL1 LOW
	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.R.LOW.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL1_CPTR_R_LOW_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.T.LOW.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL1_CPTR_T_LOW_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.Z.LOW.SNS.LL1.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL1_CPTR_Z_LOW_SNS_VAL,str_name);


	// ------------------------ ARM_A
	// LL2 HIGH
	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.R.HIGH.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL2_CPTR_R_HIGH_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.T.HIGH.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL2_CPTR_T_HIGH_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.Z.HIGH.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL2_CPTR_Z_HIGH_SNS_VAL,str_name);

	// LL2 LOW
	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.R.LOW.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL2_CPTR_R_LOW_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.T.LOW.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL2_CPTR_T_LOW_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_A.CPTR.Z.LOW.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_A_CALED_LL2_CPTR_Z_LOW_SNS_VAL,str_name);


	// ------------------------ ARM_B
	// LL2 HIGH
	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.R.HIGH.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL2_CPTR_R_HIGH_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.T.HIGH.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL2_CPTR_T_HIGH_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.Z.HIGH.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL2_CPTR_Z_HIGH_SNS_VAL,str_name);

	// LL2 LOW
	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.R.LOW.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL2_CPTR_R_LOW_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.T.LOW.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL2_CPTR_T_LOW_SNS_VAL,str_name);

	str_name.Format("OTR.IN.CALED.ARM_B.CPTR.Z.LOW.SNS.LL2.VALUE");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "microns", 0, -9999999, 9999999, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_ARM_B_CALED_LL2_CPTR_Z_LOW_SNS_VAL,str_name);


	// VAC_RB CPTR Sensor Number
	str_name.Format("OTR.IN.CFG.aCPTR.SNS.LL1.NUM");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "num", 0, 1, 10, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG_LL1_CPTR_SNS_NUM,str_name);
	
	// VAC_RB CPTR Sensor Number
	str_name.Format("OTR.IN.CFG.aCPTR.SNS.LL2.NUM");
	STD__ADD_ANALOG_WITH_X_OPTION(str_name, "num", 0, 1, 10, "");
	LINK__VAR_ANALOG_CTRL(aCH__OTR_IN_CFG_LL2_CPTR_SNS_NUM,str_name);
	...
	for(i=0;i<m_nPM_LIMIT;i++)
	{
		...
		// Dynamic Align Use
		str_name.Format("OTR.IN.CFG.dPM%1d.DYNAMIC.ALIGN.USE",i+1);
		STD__ADD_DIGITAL_WITH_X_OPTION(str_name, "NO YES", "");
		LINK__VAR_DIGITAL_CTRL(dCH__CFG_PMx_DYNAMIC_ALIGN_USE[i], str_name);
	}

	// Dynamic Align Use
	str_name.Format("OTR.IN.CFG.dLL1.DYNAMIC.ALIGN.USE");
	STD__ADD_DIGITAL_WITH_X_OPTION(str_name, "NO YES", "");
	LINK__VAR_DIGITAL_CTRL(dCH__CFG_LL1_DYNAMIC_ALIGN_USE, str_name);

	str_name.Format("OTR.IN.CFG.dLL2.DYNAMIC.ALIGN.USE");
	STD__ADD_DIGITAL_WITH_X_OPTION(str_name, "NO YES", "");
	LINK__VAR_DIGITAL_CTRL(dCH__CFG_LL2_DYNAMIC_ALIGN_USE, str_name);
...
int CObj__VacRobot_WAVEII::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
int CObj__VacRobot_WAVEII::__DEFINE__VARIABLE_IO(p_io_variable)
{
...
//--------------------------------------------------------------------------------
int CObj__VacRobot_WAVEII::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString str_name;
...
int CObj__VacRobot_WAVEII::__INITIALIZE__IO(p_io_para)
{
	//------------------------------------------------------
...
//--------------------------------------------------------------------------------
int CObj__VacRobot_WAVEII::__CALL__CONTROL_MODE(mode, p_debug, p_variable, p_alarm)
{
LOOP_RETRY:
	...
	// dCH__ROBOT_ACTION_STS->Set__DATA("END");

	return flag;
}

int CObj__VacRobot_WAVEII::__CALL__MONITORING(id, p_variable, p_alarm)
{
	switch(id)
	{
