...
private:
	...
	CX__VAR_DIGITAL_CTRL dDA_PMC_CHART_ARM_A_UPDATE_FLAG_X[CFG_PMx__SIZE];
	CX__VAR_DIGITAL_CTRL dDA_PMC_CHART_ARM_B_UPDATE_FLAG_X[CFG_PMx__SIZE];
	CX__VAR_DIGITAL_CTRL dDA_PMC_CHART_DATA_CLEAR_X[CFG_PMx__SIZE];

	CX__VAR_STRING_CTRL	 sDA_PMC_CHART_ARM_A_ROFFSET_DISPLAY_X[CFG_PMx__SIZE];
	CX__VAR_STRING_CTRL	 sDA_PMC_CHART_ARM_A_TOFFSET_DISPLAY_X[CFG_PMx__SIZE];
	CX__VAR_STRING_CTRL	 sDA_PMC_CHART_ARM_B_ROFFSET_DISPLAY_X[CFG_PMx__SIZE];
	CX__VAR_STRING_CTRL	 sDA_PMC_CHART_ARM_B_TOFFSET_DISPLAY_X[CFG_PMx__SIZE];

	//
	CX__VAR_DIGITAL_CTRL dDA_LL_CHART_ARM_A_UPDATE_FLAG_X[CFG_LBx__SIZE];
	CX__VAR_DIGITAL_CTRL dDA_LL_CHART_ARM_B_UPDATE_FLAG_X[CFG_LBx__SIZE];
	CX__VAR_DIGITAL_CTRL dDA_LL_CHART_DATA_CLEAR_X[CFG_LBx__SIZE];

	CX__VAR_STRING_CTRL  sDA_LL_CHART_ARM_A_ROFFSET_DISPLAY_X[CFG_LBx__SIZE];
	CX__VAR_STRING_CTRL  sDA_LL_CHART_ARM_A_TOFFSET_DISPLAY_X[CFG_LBx__SIZE];
	CX__VAR_STRING_CTRL  sDA_LL_CHART_ARM_B_ROFFSET_DISPLAY_X[CFG_LBx__SIZE];
	CX__VAR_STRING_CTRL  sDA_LL_CHART_ARM_B_TOFFSET_DISPLAY_X[CFG_LBx__SIZE];
	...
	// ...
	CX__VAR_STRING_CTRL  sDA_PMC_CHART_ROFFSET_DISPLAY_X[CFG_PMx__SIZE];
	CX__VAR_STRING_CTRL	 sDA_PMC_CHART_TOFFSET_DISPLAY_X[CFG_PMx__SIZE];

	CX__VAR_STRING_CTRL  sDA_LL_CHART_ROFFSET_DISPLAY_X[CFG_LBx__SIZE];
	CX__VAR_STRING_CTRL  sDA_LL_CHART_TOFFSET_DISPLAY_X[CFG_LBx__SIZE];
	...
	// CONFIG CHANNEL
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_CFG__R_OFFSET_HARD_TOLERANCE_LL_RET_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_CFG__T_OFFSET_HARD_TOLERANCE_LL_RET_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_CFG__R_OFFSET_SOFT_TOLERANCE_LL_RET_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_CFG__T_OFFSET_SOFT_TOLERANCE_LL_RET_X[CFG_LBx__SIZE];

	CX__VAR_ANALOG_CTRL  aCH__CFG_LLx_STN_NUM[CFG_LBx__SIZE];
	...
	// HIGH ...
	// ARM_A
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_A_CALED_LL_CPTR_R_HIGH_SNS_VAL_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_A_CALED_LL_CPTR_T_HIGH_SNS_VAL_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_A_CALED_LL_CPTR_Z_HIGH_SNS_VAL_X[CFG_LBx__SIZE];
	// ARM_B
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_B_CALED_LL_CPTR_R_HIGH_SNS_VAL_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_B_CALED_LL_CPTR_T_HIGH_SNS_VAL_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_B_CALED_LL_CPTR_Z_HIGH_SNS_VAL_X[CFG_LBx__SIZE];

	// LOW ...
	// ARM_A
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_A_CALED_LL_CPTR_R_LOW_SNS_VAL_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_A_CALED_LL_CPTR_T_LOW_SNS_VAL_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_A_CALED_LL_CPTR_Z_LOW_SNS_VAL_X[CFG_LBx__SIZE];
	// ARM_B
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_B_CALED_LL_CPTR_R_LOW_SNS_VAL_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_B_CALED_LL_CPTR_T_LOW_SNS_VAL_X[CFG_LBx__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__OTR_IN_ARM_B_CALED_LL_CPTR_Z_LOW_SNS_VAL_X[CFG_LBx__SIZE];

	//
	CX__VAR_ANALOG_CTRL  aCH__CFG_CPTR_SNS__LLx_NUM[CFG_LBx__SIZE];
	...
	// CFG : DYNAMIC ...
	CX__VAR_DIGITAL_CTRL dCH__CFG_PMx_DA_USE[CFG_PMx__SIZE];
	CX__VAR_DIGITAL_CTRL dCH__CFG_LLx_DA_USE[CFG_LBx__SIZE];
	...
	CX__VAR_STRING_CTRL  sCH__RQSTN_SNS_X_VALUE; // KMS : Transferom R,T -> X, Y
	CX__VAR_STRING_CTRL  sCH__RQSTN_SNS_Y_VALUE; // KMS : Transferom R,T -> X, Y
	...
	CX__VAR_DIGITAL_CTRL diCH__ROBOT_STATE_READ;
