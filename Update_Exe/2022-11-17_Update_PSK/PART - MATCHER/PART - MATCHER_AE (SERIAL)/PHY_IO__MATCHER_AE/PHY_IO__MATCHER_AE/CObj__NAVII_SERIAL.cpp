...
int CObj__NAVII_SERIAL::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// PARA ...
	{
		...
		// LOAD.POS ...
		{
			...
			str_name = "PARA.LOAD_POS.CH2"; // 제거예정
			STD__ADD_ANALOG(str_name, "%", 2, 0.0, 100.0);
			...
			str_name = "CUR.LOAD_POS.CH2"; // 제거예정
			STD__ADD_STRING(str_name);
	...
	// INFO ...
	{
		...
		//
		str_name = "INFO.CAP_POS.CH";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_CAP_POS_CH, str_name);
		...
		str_name = "INFO.CAP_VOLTAGE.CH1";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_CAP_VOLTAGE_CH1, str_name);

		str_name = "INFO.CAP_VOLTAGE.CH2";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_CAP_VOLTAGE_CH2, str_name);
		...
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_VOLTAGE_IN_SNS, str_name);

		str_name = "INFO.IN_CURRENT";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_CURRENT_IN_SNS, str_name);

		str_name = "INFO.IN_R_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_REAL_IN_SNS, str_name);

		str_name = "INFO.IN_X_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_IMAGE_IN_SNS, str_name);

		str_name = "INFO.IN_GAMMA_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_GAMMA_IN_SNS, str_name);


		str_name = "INFO.OUT1_VOLTAGE_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_VOLTAGE_OUT_SNS1, str_name);

		str_name = "INFO.OUT1_CURRENT";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_CURRENT_OUT_SNS1, str_name);

		str_name = "INFO.OUT1_R_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_REAL_OUT_SNS1, str_name);

		str_name = "INFO.OUT1_X_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_IMAGE_OUT_SNS1, str_name);

		str_name = "INFO.OUT1_DELIVERED_POWER_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_DELIVERY_POWER_OUT_SNS1, str_name);

		str_name = "INFO.OUT1_PHASE_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_PHASE_OUT_SNS1, str_name);

		str_name = "INFO.OUT2_VOLTAGE_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_VOLTAGE_OUT_SNS2, str_name);

		str_name = "INFO.OUT2_CURRENT";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_CURRENT_OUT_SNS2, str_name);

		str_name = "INFO.OUT2_R_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_REAL_OUT_SNS2, str_name);

		str_name = "INFO.OUT2_X_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_IMAGE_OUT_SNS2, str_name);

		str_name = "INFO.OUT2_DELIVERED_POWER_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_DELIVERY_POWER_OUT_SNS2, str_name);

		str_name = "INFO.OUT2_PHASE_SENSOR";	  
		STD__ADD_STRING(str_name);	
		LINK__VAR_STRING_CTRL(sCH__INFO_PHASE_OUT_SNS2, str_name);
