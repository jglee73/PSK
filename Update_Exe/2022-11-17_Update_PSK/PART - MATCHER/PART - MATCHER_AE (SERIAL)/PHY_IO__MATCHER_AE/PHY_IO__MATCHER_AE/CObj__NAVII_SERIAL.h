...
private:
	...
	//
	CX__VAR_ANALOG_CTRL  aCH__PARA_CAP_POS_CH;//KMS
	CX__VAR_STRING_CTRL  sCH__CUR_CAP_POS_CH; //KMS
	
	//....
	// MON > Report Process Status(162)
	//
	CX__VAR_DIGITAL_CTRL aCH__PARA_MATCH_OUTPUT_ON_CH1; //Byte0 - 0, 1
	//sCH__INFO_CTRL_MODE_CH1 // Byte1 - 4, 5 (automatic tune & host control mode)

	CX__VAR_STRING_CTRL  sCH__FAULT_STATUS; //
	...
	CX__VAR_STRING_CTRL  sCH__INFO_CTRL_MODE_CH2;	  // 삭제 예정

	CX__VAR_STRING_CTRL  sCH__INFO_LOAD_POS_CH1;	  
	CX__VAR_STRING_CTRL  sCH__INFO_LOAD_POS_CH2;	  // 삭제 예정

	CX__VAR_STRING_CTRL  sCH__INFO_TUNE_POS_CH1;	  
	CX__VAR_STRING_CTRL  sCH__INFO_TUNE_POS_CH2;	  // 삭제 예정

	CX__VAR_STRING_CTRL  sCH__INFO_CAP_POS_CH;	    
	CX__VAR_STRING_CTRL  sCH__INFO_CAP_CURRENT_CH;

	CX__VAR_STRING_CTRL  sCH__INFO_CAP_VOLTAGE_CH1; // 삭제 예정
	CX__VAR_STRING_CTRL  sCH__INFO_CAP_VOLTAGE_CH2; // 삭제 예정

	CX__VAR_STRING_CTRL  sCH__INFO_CAP_CURRENT_CH1;	 // 삭제 예정
	CX__VAR_STRING_CTRL  sCH__INFO_CAP_CURRENT_CH2;	 // 삭제 예정
	

	CX__VAR_STRING_CTRL  sCH__INFO_R_SENSOR_CH1; // 삭제 예정
	CX__VAR_STRING_CTRL  sCH__INFO_R_SENSOR_CH2; // 삭제 예정

	CX__VAR_STRING_CTRL  sCH__INFO_X_SENSOR_CH1; // 삭제 예정
	CX__VAR_STRING_CTRL  sCH__INFO_X_SENSOR_CH2; // 삭제 예정


	//..
	CX__VAR_ANALOG_CTRL  aCH__INFO_LOAD_POS_CH1;
	CX__VAR_ANALOG_CTRL  aCH__INFO_TUNE_POS_CH1;
	CX__VAR_ANALOG_CTRL  aCH__INFO_CAP_POS_CH;

	CX__VAR_ANALOG_CTRL  aCH__INFO_VOLTAGE_IN_SNS;
	CX__VAR_ANALOG_CTRL  aCH__INFO_CURRENT_IN_SNS;
	CX__VAR_ANALOG_CTRL  aCH__INFO_REAL_IN_SNS;
	CX__VAR_ANALOG_CTRL  aCH__INFO_IMAGE_IN_SNS;
	CX__VAR_ANALOG_CTRL  aCH__INFO_GAMMA_IN_SNS;

	CX__VAR_ANALOG_CTRL  aCH__INFO_PHASE_OUT_SNS1;
	CX__VAR_ANALOG_CTRL  aCH__INFO_DELIVERY_POWER_OUT_SNS1;
	CX__VAR_ANALOG_CTRL  aCH__INFO_REAL_OUT_SNS1;
	CX__VAR_ANALOG_CTRL  aCH__INFO_IMAGE_OUT_SNS1;
	CX__VAR_ANALOG_CTRL  aCH__INFO_VOLTAGE_OUT_SNS1;
	CX__VAR_ANALOG_CTRL  aCH__INFO_CURRENT_OUT_SNS1;

	CX__VAR_ANALOG_CTRL  aCH__INFO_PHASE_OUT_SNS2;
	CX__VAR_ANALOG_CTRL  aCH__INFO_DELIVERY_POWER_OUT_SNS2;
	CX__VAR_ANALOG_CTRL  aCH__INFO_REAL_OUT_SNS2;
	CX__VAR_ANALOG_CTRL  aCH__INFO_IMAGE_OUT_SNS2;
	CX__VAR_ANALOG_CTRL  aCH__INFO_VOLTAGE_OUT_SNS2;
	CX__VAR_ANALOG_CTRL  aCH__INFO_CURRENT_OUT_SNS2;
	//..

	// MON > Report Input/Output Sensor Data
	CX__VAR_STRING_CTRL sCH__INFO_VOLTAGE_IN_SNS;
	CX__VAR_STRING_CTRL sCH__INFO_CURRENT_IN_SNS;
	CX__VAR_STRING_CTRL sCH__INFO_REAL_IN_SNS;
	CX__VAR_STRING_CTRL sCH__INFO_IMAGE_IN_SNS;
	CX__VAR_STRING_CTRL sCH__INFO_GAMMA_IN_SNS;

	//AUX_CAP_SNS1
	CX__VAR_STRING_CTRL sCH__INFO_PHASE_OUT_SNS1;
	CX__VAR_STRING_CTRL sCH__INFO_DELIVERY_POWER_OUT_SNS1;
	CX__VAR_STRING_CTRL sCH__INFO_REAL_OUT_SNS1;
	CX__VAR_STRING_CTRL sCH__INFO_IMAGE_OUT_SNS1;
	CX__VAR_STRING_CTRL sCH__INFO_VOLTAGE_OUT_SNS1;
	CX__VAR_STRING_CTRL sCH__INFO_CURRENT_OUT_SNS1;
	
	//AUX_CAP_SNS2
	CX__VAR_STRING_CTRL sCH__INFO_PHASE_OUT_SNS2;
	CX__VAR_STRING_CTRL sCH__INFO_DELIVERY_POWER_OUT_SNS2;

	CX__VAR_STRING_CTRL sCH__INFO_REAL_OUT_SNS2;
	CX__VAR_STRING_CTRL sCH__INFO_IMAGE_OUT_SNS2;
	
	CX__VAR_STRING_CTRL sCH__INFO_VOLTAGE_OUT_SNS2;
	CX__VAR_STRING_CTRL sCH__INFO_CURRENT_OUT_SNS2;

	//MATCH FAULT_STATUS
	CX__VAR_DIGITAL_CTRL dCH__INFO_OUTPUT_ON;
	CX__VAR_DIGITAL_CTRL dCH__INFO_OUTPUT_TUNED;
	CX__VAR_DIGITAL_CTRL dCH__INFO_LOW_24V_SUPPLY;
	CX__VAR_DIGITAL_CTRL dCH__INFO_OVERTEMP;
	CX__VAR_DIGITAL_CTRL dCH__INFO_INTERLOCK_OPEN;
	CX__VAR_DIGITAL_CTRL dCH__INFO_AUX_CAP_TUNED;
	CX__VAR_DIGITAL_CTRL dCH__INFO_FAN_FAULT;
	CX__VAR_DIGITAL_CTRL dCH__INFO_WARNING_EXIST;
	CX__VAR_DIGITAL_CTRL dCH__INFO_LATCH_FAULT_EXIST;
	CX__VAR_DIGITAL_CTRL dCH__INFO_MOTOR_FAIL_INIT;
	CX__VAR_DIGITAL_CTRL dCH__INFO_VOLTAGE_OVER_LIMIT;
	
	//MATCHER TYPE
	CX__VAR_DIGITAL_CTRL dCH__MAT_TYPE;
	...
	CX__VAR_STRING_CTRL	 siCH__REPORT_PROCESS_STATUS; //KMS

	CX__VAR_STRING_CTRL	 siCH__REPORT_AUXILIARY_CAP_PARM; // KMS
	CX__VAR_STRING_CTRL  siCH__REPORT_INPUT_SNS_DATA; // KMS
	CX__VAR_STRING_CTRL  siCH__REPORT_OUTPUT_SNS1_DATA; // KMS
	CX__VAR_STRING_CTRL  siCH__REPORT_OUTPUT_SNS2_DATA; // KMS
	CX__VAR_STRING_CTRL  siCH__REPORT_CONDENSED_MATCH_SNAPSHOT; // KMSL221102 
	...
	CX__VAR_DIGITAL_CTRL doCH__AUXILIARY_CAP_POS; // 

	CX__VAR_DIGITAL_CTRL doCH__CLEAR_LATCH_FAULTS; // KMS:221028 CLEAR__LATCH_FAULTS
	...
	// ...
	int _Convert_ToInt(int start_idx, int end_idx, unsigned char* data);
