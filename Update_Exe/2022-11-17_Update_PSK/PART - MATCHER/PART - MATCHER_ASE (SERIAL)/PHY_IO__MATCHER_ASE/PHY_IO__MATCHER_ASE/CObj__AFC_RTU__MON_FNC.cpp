...
::Mon__MONITOR(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm)
{
	...
	if(iActive__SIM_MODE > 0)
	{
		...
		aCH__MON_CUR_DELIVERY_POWER ->Set__VALUE(0.0);
		aCH__MON_CUR_IMAGE ->Set__VALUE(0.0);
		aCH__MON_CUR_REAL ->Set__VALUE(0.0);
		aCH__MON_CUR_IMPEDANCE ->Set__VALUE(0.0);
		sCH__MON_CUR_Phase ->Set__DATA("0");
		sCH__MON_CUR_IRMS ->Set__DATA("0");
		sCH__MON_CUR_VRMS ->Set__DATA("0");
		sCH__MON_CUR_VPP ->Set__DATA("0");
