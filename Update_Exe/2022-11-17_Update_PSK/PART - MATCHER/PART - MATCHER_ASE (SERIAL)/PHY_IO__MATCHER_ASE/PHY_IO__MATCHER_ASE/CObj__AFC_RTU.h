...
private:
	...
	CX__VAR_ANALOG_CTRL  aCH__MON_CUR_IMPEDANCE;		//KMS
	CX__VAR_ANALOG_CTRL  aCH__MON_CUR_REAL;				//KMS
	CX__VAR_ANALOG_CTRL  aCH__MON_CUR_IMAGE;			//KMS
	CX__VAR_ANALOG_CTRL  aCH__MON_CUR_DELIVERY_POWER;	//KMS
	...
	CX__VAR_STRING_CTRL  siCH__Matcher_Info;	//KMS
	...
	unsigned int _Make__WRITE_PACKET_EX(unsigned char* s_data, 
										const unsigned char addr_id,
										const unsigned char cmmd_id,
										const unsigned int  start_addr,
