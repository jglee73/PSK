...
int CObj__AFC_RTU::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// MON ...
	{
		...
		str_name = "MON.CUR.Impedance_Z";						//KMS
		STD__ADD_ANALOG(str_name,"R",2,-65535,65535);
		LINK__VAR_ANALOG_CTRL(aCH__MON_CUR_IMPEDANCE, str_name);
	
		str_name = "MON.CUR.Real_R";							//KMS
		STD__ADD_ANALOG(str_name,"R",2,-65535,65535);
		LINK__VAR_ANALOG_CTRL(aCH__MON_CUR_REAL, str_name);

		str_name = "MON.CUR.Image_X";							//KMS
		STD__ADD_ANALOG(str_name,"R",2,-65535,65535);
		LINK__VAR_ANALOG_CTRL(aCH__MON_CUR_IMAGE, str_name);

		str_name = "MON.CUR.Delivery_Power";					//KMS
		STD__ADD_ANALOG(str_name,"W",2,-65535,65535);
		LINK__VAR_ANALOG_CTRL(aCH__MON_CUR_DELIVERY_POWER, str_name);
...
int CObj__AFC_RTU::__DEFINE__VARIABLE_IO(p_io_variable)
{
	...
	// SI ...
	{
		...
		str_name = "si.Matcher_Info";
		IO__ADD_STRING_READ(str_name);
		LINK__IO_VAR_STRING_CTRL(siCH__Matcher_Info,str_name);
