				 ...
				 CStringArray& l_err)
{
	...
	while(1)
	{
		...
		for(k=0; k<k_limit; k++)
		{
			...
			{	
				...
				if(key_word.CompareNoCase(_NAK) == 0)
				{
					active__nak_check = true;
					break;
				}
			}
		}
	...
	if(active__nak_check)			return -11;
	return 1;
}
