...
private:
	...
	// MON : IO ...
	CX__VAR_STRING_CTRL  sCH__MON_DO_POWER_SET;
	...
	CString sLINK__RF_MODE__POWER_SET;
	CString sLINK__RF_MODE__POWER_ON;
	...
	bool bActive__DO_RF_POWER_CONNECTOR;
	CX__VAR_DIGITAL_CTRL dEXT_CH__DO_RF_POWER_CONNECTOR;
	...
	CX__VAR_DIGITAL_CTRL dEXT_CH__INFO_DI_RF_POWER; //KMS
	CX__VAR_STRING_CTRL  sEXT_CH__INFO_RF_ALARM; //KMS
	CX__VAR_DIGITAL_CTRL dEXT_CH__RF_ALARM;		 //KMS
	...
	int Call__POWER_SET(CII_OBJECT__VARIABLE *p_variable, CII_OBJECT__ALARM *p_alarm);
	...
	int Mon__IO_TYPE_ALARM_CHECK(CII_OBJECT__VARIABLE *p_variable, CII_OBJECT__ALARM *p_alarm);
	// ...
