...
private:
	...
	bool bActive__OBJ_CTRL__CHM_FNC;			//KMS
	CII_EXT_OBJECT__CTRL *pOBJ_CTRL__CHM_FNC;	//KMS
	CString sLINK_MODE__BALLAST_END;			//KMS
	CX__VAR_DIGITAL_CTRL dEXT_CH__LINK_CFG_TRANSFER_BALLAST_ENABLED;	//KMS
